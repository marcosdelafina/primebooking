-- Migration: Update Edge Function URLs to current project ID
-- Date: 2026-02-03
-- Description: Standardizes all notification triggers to use the linked project ID 'pouzpiulazrhutzzkbes'.
